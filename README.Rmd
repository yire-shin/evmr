...
---
title: "evmr: Extreme Value Modeling for r-Largest Order Statistics"
...
The package provides tools for fitting, analyzing, and comparing
extreme value models that use the **largest r observations within each
block**.
